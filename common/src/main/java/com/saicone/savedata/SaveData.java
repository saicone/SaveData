...
@Dependencies(value = {
        ...
        // Settings
        @Dependency("com{}saicone:settings:1.0.6"),
        @Dependency("com{}saicone:settings-gson:1.0.6"),
        @Dependency("com{}saicone:settings-hocon:1.0.6"),
        @Dependency("com{}saicone:settings-toml:1.0.6"),
        @Dependency("com{}saicone:settings-yaml:1.0.6"),
        @Dependency("org.yaml:snakeyaml:2.5"),
        // Delivery4j
        @Dependency("com{}saicone:delivery4j:1.1.6"),
        @Dependency("com{}saicone:delivery4j-broker-sql-hikari:1.1.6"),
